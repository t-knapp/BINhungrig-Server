...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Ingredients_BINS` BEFORE INSERT ON `Ingredients` FOR EACH ROW
BEGIN
    SET NEW.seq = getNextSeq("sync");
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Ingredients_BUPD` BEFORE UPDATE ON `Ingredients` FOR EACH ROW
BEGIN
    SET NEW.seq = getNextSeq("sync");
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Ingredients_BDEL` BEFORE DELETE ON `Ingredients` FOR EACH ROW
BEGIN
    INSERT INTO _deletes(`seq`,`tableName`,`deleteSeqNumber`) 
    VALUES(getNextSeq("sync"), "Ingredient", OLD.seq);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2015-11-25  0:52:31
